...
public class forgotForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtUname.setText("           Entrez le CIN à rechercher.");
        ...
        jLabel5.setText("Question de sécurité :");
    ...
    private void txtUnameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtUnameFocusGained
        // TODO add your handling code here:
        if (txtUname.getText().trim().equals("           Entrez le CIN à rechercher.")) {
            txtUname.setText("");
        }
    ...
    private void btnRecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRecActionPerformed
        ...
        if (ans.equals("")) {
            JOptionPane.showMessageDialog(null, "Veuillez remplir la réponse pour récupérer le mot de passe");
        } else {
            try {
                ...
                if (rs.next()) {
                    ...
                    txtPass.setText("votre mot de passe est "+answer);
                } else {
                    JOptionPane.showMessageDialog(null, "La réponse ne correspond pas à la base de données");
                }
            } catch (Exception ex) {
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Nom d’utilisateur introuvable dans la base de données");
                }
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, ex);
            }
