...
public class loginForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (uname.equalsIgnoreCase("")) {
            ...
            JOptionPane.showMessageDialog(null, "le mot de passe n'est pas valide");
        } else {
            try {
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Identification réussie");
                    mainForm m = new mainForm(name,des);
                    m.setVisible(true);
                    this.dispose();
                } else {
                    JOptionPane.showMessageDialog(null, "Nom d’utilisateur ou mot de passe est incorect");
                }
            } catch (Exception ex) {
